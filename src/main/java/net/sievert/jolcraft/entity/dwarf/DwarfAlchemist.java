...
public class DwarfAlchemist extends DwarfEntity {
    public DwarfAlchemist(EntityType<? extends DwarfEntity> entityType, Level level) {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor levelAccessor, DifficultyInstance difficultyInstance, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        ...
        this.setVillagerData(this.getVillagerData().setProfession(JolCraftVillagers.ALCHEMIST.get()));
