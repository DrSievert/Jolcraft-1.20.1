...
public class DwarfBlacksmith extends DwarfEntity {
    public DwarfBlacksmith(EntityType<? extends DwarfEntity> entityType, Level level) {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor levelAccessor, DifficultyInstance difficultyInstance, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        ...
        this.setVillagerData(this.getVillagerData().setProfession(JolCraftVillagers.BLACKSMITH.get()));
