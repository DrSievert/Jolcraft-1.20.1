...
public class DwarfEnchanter extends DwarfEntity {
    public DwarfEnchanter(EntityType<? extends DwarfEntity> entityType, Level level) {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor levelAccessor, DifficultyInstance difficultyInstance, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        ...
        this.setVillagerData(this.getVillagerData().setProfession(JolCraftVillagers.ENCHANTER.get()));
