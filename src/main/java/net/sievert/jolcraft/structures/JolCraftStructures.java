package net.sievert.jolcraft.structures;

import com.mojang.serialization.Codec;
import net.sievert.jolcraft.structures.custom.JolCraftForgeStructure;
...
public class JolCraftStructures {
     ...
     */
    public static final RegistryObject<StructureType<JolCraftForgeStructure>> FORGE = DEFERRED_REGISTRY_STRUCTURE.register("forge", () -> explicitStructureTypeTyping(JolCraftForgeStructure.CODEC));
